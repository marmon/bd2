...
Insert into BD2A14.KLIENCI (ID_KLIENTA,NUMER_DOKUMENTU,IMIE,NAZWISKO,NUMER_TELEFONU,KRAJ,MIEJSCOWOSC,KOD_POCZTOWY,ULICA,NUMER_ULICY,NUMER_MIESZKANIA) values (23,'dok55','stefan','roman',123123123,null,null,null,null,null,null);
Insert into BD2A14.KLIENCI (ID_KLIENTA,NUMER_DOKUMENTU,IMIE,NAZWISKO,NUMER_TELEFONU,KRAJ,MIEJSCOWOSC,KOD_POCZTOWY,ULICA,NUMER_ULICY,NUMER_MIESZKANIA) values (24,'dokument335','stefek','stefanowski',123456123,null,null,null,null,null,null);
Insert into BD2A14.KLIENCI (ID_KLIENTA,NUMER_DOKUMENTU,IMIE,NAZWISKO,NUMER_TELEFONU,KRAJ,MIEJSCOWOSC,KOD_POCZTOWY,ULICA,NUMER_ULICY,NUMER_MIESZKANIA) values (25,'dokument5506','roman','romanowski',94949,null,null,null,null,null,null);
...
Insert into BD2A14.POZYCJE_REZERWACJI (NUMER_POKOJU,ID_REZERWACJI,OD,DO) values (1,5,to_date('11/12/12','RR/MM/DD'),to_date('11/12/13','RR/MM/DD'));
REM INSERTING into BD2A14.REZERWACJE
Insert into BD2A14.REZERWACJE (ID_REZERWACJI,ID_KLIENTA,DATA_ZALOZENIA,WARTOSC) values (5,25,to_date('11/12/20','RR/MM/DD'),50);
...
--------------------------------------------------------
--  DDL for Trigger RESERVATION_TRIGGER_VALUE
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "BD2A14"."RESERVATION_TRIGGER_VALUE" 
AFTER INSERT ON POZYCJE_REZERWACJI 
REFERENCING NEW AS new
FOR EACH ROW
DECLARE
  price number;
BEGIN
  UPDATE REZERWACJE SET WARTOSC = WARTOSC + (SELECT CENA FROM POKOJE P, TYPY_POKOI T WHERE P.NUMER_POKOJU = :new.NUMER_POKOJU AND P.ID_TYPU_POKOJU = T.ID_TYPU_POKOJU)
  WHERE ID_REZERWACJI = :new.ID_REZERWACJI;
END;
/
ALTER TRIGGER "BD2A14"."RESERVATION_TRIGGER_VALUE" ENABLE;
--------------------------------------------------------
